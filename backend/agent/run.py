...
from agent.tools.dify_chatflow_tool import DifyChatflowTool
...
async def run_agent(
    ...
    if config.DIFY_API_KEY and config.DIFY_CHATFLOW_URL:
        thread_manager.add_tool(DifyChatflowTool, project_id=project_id, thread_id=thread_id, thread_manager=thread_manager)
